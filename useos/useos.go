...
func useFilefunc() {
	...
	fmt.Println("New a file associated with sterr ...")
	file3 := os.NewFile(uintptr(syscall.Stderr), "/dev/stderr")
	if file3 != nil {
		file3.WriteString("The Go language program wites something to stderr.\n")
	}
	fmt.Println()
	...
	fmt.Printf("Is there only one file descriptor for the same file int same process?%v\n",
		file5a.Fd() == file4.Fd())
