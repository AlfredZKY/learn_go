...
type MainInfo struct {
	...
	Api       string `protobuf:"bytes,4,opt,name=api,proto3" json:"api,omitempty"`             // 从miner如果转正时，需要给worker集群自己的api数据
	Token     string `protobuf:"bytes,5,opt,name=token,proto3" json:"token,omitempty"`         // 同上，给worker集群自己的token
	Reserfile string `protobuf:"bytes,6,opt,name=reserfile,proto3" json:"reserfile,omitempty"` // 保留字段，看看还需要传递什么字段
}
...
func (x *MainInfo) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *MainInfo) GetReserfile() string {
	if x != nil {
		return x.Reserfile
	}
	return ""
...
type SubInfo struct {
	...
	Status bool   `protobuf:"varint,2,opt,name=status,proto3" json:"status,omitempty"` // 从之间相互心跳之间的状态，true在线 false不在线
}
...
var file_protocol_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x22, 0x90, 0x01, 0x0a, 0x08, 0x4d,
	0x61, 0x69, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x16, 0x0a, 0x06, 0x77, 0x65, 0x69, 0x67, 0x68,
	...
	0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x70, 0x12, 0x10, 0x0a, 0x03, 0x61, 0x70, 0x69, 0x18, 0x04,
	...
	0x1c, 0x0a, 0x09, 0x72, 0x65, 0x73, 0x65, 0x72, 0x66, 0x69, 0x6c, 0x65, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x09, 0x72, 0x65, 0x73, 0x65, 0x72, 0x66, 0x69, 0x6c, 0x65, 0x22, 0x3d, 0x0a,
	0x09, 0x4d, 0x61, 0x69, 0x6e, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x30, 0x0a, 0x09, 0x6d, 0x61,
	0x69, 0x6e, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x4d, 0x61, 0x69, 0x6e, 0x49, 0x6e, 0x66,
	0x6f, 0x52, 0x09, 0x6d, 0x61, 0x69, 0x6e, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x22, 0x31, 0x0a, 0x07,
	0x53, 0x75, 0x62, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x70, 0x18, 0x01, 0x20,
	...
	0x37, 0x0a, 0x08, 0x53, 0x75, 0x62, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x2b, 0x0a, 0x07, 0x73,
	0x75, 0x62, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x53, 0x75, 0x62, 0x49, 0x6e, 0x66, 0x6f, 0x52,
	0x07, 0x73, 0x75, 0x62, 0x69, 0x6e, 0x66, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
