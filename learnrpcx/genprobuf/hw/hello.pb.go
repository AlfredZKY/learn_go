...
var fileDescriptor_61ef911816e0a8ce = []byte{
	...
	0xc9, 0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x04, 0x73, 0xca, 0xf3, 0x8b, 0x52, 0x94,
	0x94, 0xb8, 0x78, 0x3c, 0x40, 0x9c, 0xa0, 0xd4, 0xc2, 0xd2, 0xd4, 0xe2, 0x12, 0x21, 0x21, 0x2e,
	...
	0x1d, 0xa6, 0x08, 0xc6, 0x35, 0x72, 0xe5, 0x62, 0x75, 0x2f, 0x4a, 0x4d, 0x2d, 0x11, 0xb2, 0xe1,
	0xe2, 0x08, 0x4e, 0xac, 0x04, 0xeb, 0x11, 0x12, 0xd7, 0x83, 0x5b, 0xa6, 0x87, 0x6c, 0x93, 0x94,
	0x28, 0xa6, 0x44, 0x41, 0x4e, 0xa5, 0x12, 0x83, 0x93, 0xf4, 0x89, 0x47, 0x72, 0x8c, 0x17, 0x1e,
	0xc9, 0x31, 0x3e, 0x78, 0x24, 0xc7, 0x38, 0xe3, 0xb1, 0x1c, 0x43, 0x14, 0xc2, 0xbd, 0x49, 0x6c,
	0x60, 0x1f, 0x18, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x4b, 0x31, 0xf0, 0x0d, 0xd0, 0x00, 0x00,
	0x00,
}
...
func (s *GreetImpl) SayHello(ctx context.Context, args *HelloRequest, reply *HelloReply) (err error) {
...
//================== client stub===================
// Greet is a client wrapped XClient.
type GreetClient struct {
	xclient client.XClient
}

// NewGreetClient wraps a XClient as GreetClient.
// You can pass a shared XClient object created by NewXClientForGreet.
func NewGreetClient(xclient client.XClient) *GreetClient {
	return &GreetClient{xclient: xclient}
}

// NewXClientForGreet creates a XClient.
// You can configure this client with more options such as etcd registry, serialize type, select algorithm and fail mode.
func NewXClientForGreet(addr string) client.XClient {
	d := client.NewPeer2PeerDiscovery("tcp@"+addr, "")
	opt := client.DefaultOption
	opt.SerializeType = protocol.ProtoBuffer

	xclient := client.NewXClient("Greet", client.Failtry, client.RoundRobin, d, opt)
	return xclient
}

// SayHello is client rpc method as defined
func (c *GreetClient) SayHello(ctx context.Context, args *HelloRequest) (reply *HelloReply, err error) {
	reply = &HelloReply{}
